# Настройка маршрутизации в офисах Чокурдах и Лабытнанги
...
Трафик с подсети 10.3.0.0/26 будем отправлять через интерфейс e0/1, если данный канал не доступен, то через e0/0;
