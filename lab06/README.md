...
Без указания шаблонной маски, EIGRP будет основываться на классовости IP-адреса. Исключить масску можно на IP-адресе 192.168.3.1.
...
Преимущества EIGRP, как и остальных протоколах динамической маршрутизации, в отсутствии необходимости ручной поддержки в актуальном состоянии таблиц маршрутизации. Также, с помощью EIGRP, можно реализовать автоматическое резервирование каналов связи.
